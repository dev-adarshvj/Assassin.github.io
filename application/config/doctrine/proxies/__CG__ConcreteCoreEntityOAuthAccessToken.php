...
class AccessToken extends \Concrete\Core\Entity\OAuth\AccessToken implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'identifier', 'expiryDateTime', 'userIdentifier', 'scopes', 'client'];
        }
     ...
     * {@inheritDoc}
     */
    public function convertToJWT(\League\OAuth2\Server\CryptKey $privateKey)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'convertToJWT', [$privateKey]);
